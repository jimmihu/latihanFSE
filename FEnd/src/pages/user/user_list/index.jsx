...
import { GetUserList,GetUserDetail,CreateUser,DeleteUser } from '@/services/ant-design-pro/api';
...
const handleCreate = async (value) => {
  const load = message.loading('Creating User..');
  try{
...
const handleRemove = async (id) => {
  const load = message.loading('Deleting User..');
  try{
...
const UserList = () => {
  ...
  const columns2 = [
    ...
    {title: 'Personal Number',dataIndex: 'personal_number',valueType: 'text',},
    {title: 'Role',dataIndex: 'role',valueType: 'text',
      render: (_, rowData) => {
        return <>{rowData.role.title}</>;
      },
    },
